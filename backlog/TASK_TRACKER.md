...
_2026-06-02; ссылки на папки задач синхронизированы 2026-06-11 (точечно, без пересмотра приоритетов). Известный долг трекера: дубли номеров #048 (new + completed), #071 (new + future), #072 (wip + completed); #079 фактически завершена, но лежит в wip; #096/#097/#098/#100 реализованы (cb6e09d) и ждут переноса wip → completed — детали в backlog_review.md от 2026-06-11._
