...
Зафиксировать **до написания кода reporter'а** маппинг внутренних понятий cpparch (правила, нарушения, источники: Core Guidelines / Lakos / Martin) в SARIF 2.1.0, чтобы не переделывать формат после первого релиза.
