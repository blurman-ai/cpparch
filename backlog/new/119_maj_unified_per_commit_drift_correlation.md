...
**Блокирует:** —
**Заблокирован:** —
**Related:** #111/#115/#117 (lateral), #103 (copypaste per-commit), #089/#090 (boolean state), #109 (lcx), #093/#094 (flag-arg/param accretion), #077 (per-commit export)
...
### Фаза 0 — реген (предусловие)
- [ ] Пересобрать archcheck (подхватит #113/#114).
- [ ] Перегенерить `*_graph_drift.jsonl` всех реп с `--since=2024-06-01`; baselines.
