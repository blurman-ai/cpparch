...
| Файл | Изменение |
|------|-----------|
| `src/graph/graph_builder.cpp` | `filterVendored()` → двухпроходный с порогом доминирования |
| `tests/unit/graph/graph_builder_test.cpp` | новый: 4 контрольных кейса |
| `tests/CMakeLists.txt` | + новый тест-файл |
