...
> **2026-05-29:** отложено в `future/` после закрытия #043. v0.2-материал — отдельный релизный нарратив (семантические правила), не блокирует v0.1. Подбирать когда появится явный пользовательский спрос на SF.5/10/11/21 или когда v0.1 зашипится.
