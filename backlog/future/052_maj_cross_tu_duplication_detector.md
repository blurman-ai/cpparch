...
> **2026-05-29:** отложено в `future/` вместе с #042. Stage 2 садится на libclang-инфраструктуру, которая сама в future/. Stage 0 (research/proof) можно достать раньше при необходимости — независим от backend'а.
