...
- [ ] token-LCS по ВСЕМ кандидатам recall-фазы (не только по топу).
- [ ] Показывать alignment / diff-вид и место расхождения.
- [ ] Смежные delete+insert схлопывать в `changed`, чтобы отчёт был читаемым.
